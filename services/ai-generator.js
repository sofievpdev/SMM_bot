...
export function buildFullSystemPrompt(channel) {
  ...
  if (channel.contentStyle?.writingGuidelines) {
    ...
    if (wg.useEmoji) prompt += '- Использовать эмодзи: да, но со вкусом (2-4 эмодзи на весь пост, не перебор)\n';
...
- Используй эмодзи со вкусом (2-4 эмодзи на весь пост, без перебора)
...
- Используй эмодзи со вкусом (2-4 эмодзи на весь пост, не перебор)
...
- Профессиональный тон, как от опытного специалиста
- БЕЗ сленга
- Используй эмодзи со вкусом (2-4 эмодзи на весь пост, не перебор)
