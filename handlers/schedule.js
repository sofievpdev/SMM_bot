...
Длина: 900-1000 символов
Тон: профессиональный, вдохновляющий, без пафоса`;
...
async function generateInspirationPost(channel, postNumber = 1) {
  // Разные промпты для разных постов
  const prompts = [
    // Первый пост - Q&A
    `Создай пост в формате Q&A (вопрос-ответ) о здоровье и питании.

Выбери 2-3 актуальных вопроса, которые часто задают:
- Про питание и диеты
- Про энергию и усталость
- Про сон и восстановление
- Про метаболизм

Формат: Вопрос → Краткий профессиональный ответ

Требования:
- Длина: 900-1000 символов
- Тон: профессиональный, полезный
- Научная база
- CTA: "Какие вопросы есть у вас? Пишите в комментариях!"`,

    // Второй пост - Вдохновение/План на неделю
    `Создай вдохновляющий пост-план на неделю для здорового образа жизни.

Включи:
- Одну простую привычку для внедрения
- Мотивирующий факт или цитату
- Конкретное действие на эту неделю

Требования:
- Длина: 900-1000 символов
- Тон: мотивирующий, но профессиональный
- Практичность - реально выполнимые советы
- CTA: "Поделитесь своими планами на неделю!"`,
  ];
